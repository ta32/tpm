  ...
  return (
    <>
      <a className={selected ? styles.active : ''} data-tag-key={title} data-tag-name={title}>
        ...
        <Image onClick={handleClickedMore} className={`${styles.ui_icon_white} ${iconVisibility}`} src={"icons/ui/more_horiz_FILL0_wght700_GRAD200_opsz48.svg"} alt={"more"} height={24} width={24} />
      </a>
      {showControls &&
